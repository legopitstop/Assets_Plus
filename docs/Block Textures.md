...
| `minecraft:stripped_crimson_log`<br> `minecraft:stripped_crimson_log_side`<br> `minecraft:stripped_crimson_stem`<br> `minecraft:stripped_crimson_stem_side` | `textures/blocks/huge_fungus/stripped_crimson_stem_side` |
